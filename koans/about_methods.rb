...
class AboutMethods < Neo::Koan
  ...
  def method_with_defaults(a, b=:default_value) # valor por defecto
    [a, b]
  end
  ...
  if before_ruby_version("2.7")   # https://github.com/edgecase/ruby_koans/issues/12
    def test_calling_private_methods_with_an_explicit_receiver
      exception = assert_raise(SintaxError) do
        self.my_private_method
      end
      assert_match /syntax error, unexpected '.'/, exception.message
    end
  end
